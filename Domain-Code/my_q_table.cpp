...
My_Q_Table::My_Q_Table(bool learning){
...
My_Q_Table::~My_Q_Table(){}


double My_Q_Table::get_q_table_value(std::vector<int> states, int action){
...
void My_Q_Table::update_q_table(std::vector<int> states, int action, std::vector<int> next_states, double alpha, double gamma){
...
double My_Q_Table::get_reward(int action){
...
int My_Q_Table::get_best_action(std::vector<int> next_states){
...
void My_Q_Table::set_qtable_learning(bool do_learning){
    learn = do_learning;
}